...
- `patches/0612-ROCKNIX-odin3-q6apm-start-mi2s-port-at-prepare.patch`
  source: https://github.com/slaide/distribution/blob/06c1cdfdb0309c45ba7db34049b8aa4b16d20507/projects/ROCKNIX/devices/SM8750/patches/linux/0612-ROCKNIX-odin3-q6apm-start-mi2s-port-at-prepare.patch
  upstream: local
  notes: DP audio out must not start early with other MI2S sources.
  DP audio will start correctly after the MI2S has been set up.
...
- `0618-drm-msm-dp-dont-fail-audio-prepare-when-display-off`
